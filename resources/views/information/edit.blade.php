...
<div class="card shadow mb-4">
    ...
    @if(session('errors'))
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="title" value="{{ $information->title }}" id="exampleFormControlInput1" placeholder="Tulis Judul Berita">
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">Deskripsi</label>
            <textarea class="form-control" name="description" id="exampleFormControlInput1" placeholder="Tulis Deskripsi Berita">{{ $information->description }}</textarea>
        </div>
        <div class="form-group">
            <label for="exampleFormControlFile1">Input Gambar</label>
            <input type="file" name="image" value="{{ $information->image }}" class="form-control-file" id="exampleFormControlFile1">
        </div>
        <div class="form-group">
